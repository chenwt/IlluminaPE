...
from PEassembly.miscBowTie import BowTieReader, BowTieWriter, FastqReader, FastqWriter
from PEassembly.c_PrimerMatch import PrimerMatch, match_primer_len
...
#	parser.add_argument("-i", dest="input", help="Composite/Aligned input file (BowTie format, gzipped)")
	parser.add_argument("-1", dest="input1", help="Paired end Fastq file 1 (gzipped)")
	parser.add_argument("-2", dest="input2", help="Paired end Fastq file 2 (gzipped)")
